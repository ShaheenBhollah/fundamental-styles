	...
	<div class="fd-col fd-col--6">
        ...
        <div class="fd-popover">
            ...
            <div class="fd-popover__wrapper">
                <ul class="fd-list fd-list--multi-input" role="listbox">
                    <li class="fd-list__item is-selected" role="option" aria-selected="true" tabindex="0">
                    ...
                    <li class="fd-list__itemxs" role="option" tabindex="0">
...
<div class="fd-popover">
    ...
    <div class="fd-popover__body fd-popover__body--no-arrow fd-popover__body--dropdown fd-popover__body--dropdown-fill" aria-hidden="false" id="F4GcX348aB">
        <ul class="fd-list fd-list--multi-input">
			...
			<li class="fd-list__item" role="option" tabindex="0">
                <input type="checkbox" class="fd-checkbox fd-list__input" id="Ai4ez611A" tabindex="-1">
                <label class="fd-checkbox__label fd-list__label" for="Ai4ez611A">
                    <span class="fd-checkbox__text fd-list__title">
                        <b>A</b>pple
                    </span>
